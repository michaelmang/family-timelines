const array = [
  {
    ...
    cardSubtitle:
      "Smithfield Plantation | Blacksburg, Virginia",
    cardDetailedText:
  ...
  },
  {
    ...
    cardTitle: "Alamein",
    cardSubtitle:
      "German prisoners of war wait for transport after their capture at Alamein",
    media: {
      type: "IMAGE",
      source: {
        url:
  ...
  },
  {
    ...
    cardSubtitle:
      "Red Army soldiers hoist the Soviet flag over a recaptured Stalingrad factory following the German surrender",
    media: {
      type: "IMAGE",
      source: {
        url:
